...
function CategoryPage({ evaluation, category }: { evaluation: CompanyEvaluation; category: Exclude<Route["category"], "home"> }) {
  ...
  return <>
    ...
    {category === "management" && tab === "criteria" && <FounderProjectsCard evaluation={evaluation} />}
    {category === "management" && tab === "network" && <FounderNetworkGraph evaluation={evaluation} />}
